...
import com.kostya.scalesnetwork.filedialog.FileChooserDialog;
import com.kostya.scalesnetwork.provider.SenderTable;
...
public class ActivityPreferencesAdmin extends PreferenceActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public static final String ACTION_PREFERENCE_ADMIN = "com.kostya.scalesnetwork.settings.ACTION_PREFERENCE_ADMIN";
    public static final String EXTRA_BUNDLE_WIFI = "com.kostya.scalesnetwork.settings.EXTRA_BUNDLE_WIFI";
    public static final String EXTRA_BUNDLE_USB = "com.kostya.scalesnetwork.settings.EXTRA_BUNDLE_USB";
    public static final String KEY_SSID = "com.kostya.scalesnetwork.settings.KEY_SSID";
    public static final String KEY_PASS = "com.kostya.scalesnetwork.settings.KEY_PASS";

    public enum EnumPreferenceAdmin{
        TERMINALS(R.string.KEY_TERMINALS){
            @Override
            void setup(final Preference name) throws Exception {
                final Context mContext = name.getContext();
                try {
                    name.setTitle('"' + getNameOfId(mContext, Integer.valueOf(systemTable.getProperty(SystemTable.Name.TERMINAL))) + '"');
                }catch (Exception e){}
                ...
                name.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
                    ...
                    public boolean onPreferenceChange(Preference preference, Object o) {
                        ...
                        String terminalName = ((Terminals)o).name();
                        String terminalId = String.valueOf(((Terminals)o).ordinal());
                        if(systemTable.updateEntry(SystemTable.Name.TERMINAL, terminalId)){
