...
import com.kostya.scalesnetwork.task.IntentServiceHttpPost;
...
public class EventsTable {
    ...
    public Uri insertNewEvent(String text, Event event) {
        ...
        newTaskValues.put(KEY_DATE_TIME, new SimpleDateFormat("dd.MM.yyyy HH:mm:ss", Locale.getDefault()).format(new Date()));
