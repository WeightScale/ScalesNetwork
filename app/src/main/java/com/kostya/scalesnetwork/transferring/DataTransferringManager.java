...
import com.kostya.scalesnetwork.Main;
...
public class DataTransferringManager {
    ...
    private final ServerThreadManager serverThreadProcessor = new ServerThreadManager();
    ...
    public void sendObjectToAllDevicesInNetwork(final Context context, Object object){
        ...
        if (jmdns != null) {
            ...
            ArrayList<ServerThread> serverThreads = serverThreadProcessor.getListServerThreads();
    ...
    public void sendObjectToDevicesInNetwork(final Context context, final String ipAddress, final Object object){
    ...
    public void sendMessageToAllDevicesInNetwork(final Context context, final String message){
        if (jmdns != null) {
            ...
            Set<String> ipAddressesSet = getNeighborDevicesIpAddressesSet(context);
            for (final String serverIpAddress : ipAddressesSet) {
                executorService.execute(new Runnable() {
                    @Override
                    public void run() {
